...
function About() {
  ...
  if (error) {
    return (
      <div style={styles.page}>
        <Container textAlign="center" style={{ maxWidth: 800, margin: "0 auto" }}>
  ...
  return (
    <div style={styles.page}>
      {/* Центрируем контейнер и ограничиваем ширину */}
...
const styles = {
  ...
  container: {
    width: "100%",
    // maxWidth у контейнера теперь не нужен, т.к. обёртка с maxWidth есть выше
  },
  segment: {
    backgroundColor: "#fffaf0",
    padding: "2em",
    // не ставим width: 100%, чтобы не растягивался
    boxSizing: "border-box",
  },
  innerSegment: {
    wordWrap: "break-word",
